...
// ── Canopy site-settings types (mirrors backend IUserSiteSettings) ──────────

export interface ICanopyEventSettings {
  overlays?: any[];
  meta?: any;
  show_live?: boolean;
  resizer_sizes?: number[];
  right_side_sizes?: number[];
}

export interface IUserCanopyAppsSettings {
  events?: Record<string, ICanopyEventSettings>;
  last_event_id?: string;
}

export interface IUserSiteAppsSettings {
  canopy?: IUserCanopyAppsSettings;
}

export interface IUserSiteSettings {
  theme?: string;
  apps?: IUserSiteAppsSettings;
}
...
export interface IUserBackend {
  ...
  social?: ISocial[];
  server_url?: string;
  site_settings?: IUserSiteSettings;
}
