...
const MainLayout = ({ children }: IProps) => {
  ...
  const GLOBAL_SCROLL_CLASS = 'has-scrollbar-y';
  ...
  const checkScrollbar = useCallback(() => {
    ...
    const navRef:any= document.getElementById("nav-bar");
   
    navRef.classList.toggle(GLOBAL_SCROLL_CLASS, hasScrollbar)
    mainRef.current.classList.toggle(GLOBAL_SCROLL_CLASS, hasScrollbar);
  }, []);
