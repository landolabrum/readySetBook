import { systemIcons } from './categories/system_icons';
import {
  UiIconSet,
  UiIconStrokeOptions,
} from "../../../types/icons";
...
import { customRaceLines, landoTwitch } from "./categories/custom_icons";
