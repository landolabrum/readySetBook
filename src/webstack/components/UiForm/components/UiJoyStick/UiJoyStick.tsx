...
const UiJoyStick: React.FC<IUiJoyStickProps> = ({ onMove }) => {
  ...
  useEffect(() => {
    ...
    const handleMouseUp = () => {
      ...
      // Fire final position before snapping back
      if (onMove && (pos[0] !== 0 || pos[1] !== 0)) onMove(pos[0], pos[1]);
    ...
    <>
      ...
      <div className='joystick__container'>
        <div className='joystick__grid'>
          <div className='joystick__axis joystick__axis--x'>
            <span className='joystick__label'>-x</span>
            <span className='joystick__label'>x</span>
          </div>
          <div className='joystick__axis joystick__axis--y'>
            <span className='joystick__label'>y</span>
            <span className='joystick__label'>-y</span>
          </div>
          <div className='joystick__rings'>
            <span className='joystick__ring' />
            <span className='joystick__ring' />
            <span className='joystick__ring' />
          </div>
        </div>
        ...
        <div ref={joystickRef} className='joystick'>
          ...
          >
            <div className='joystick-thumb__dot' />
          </div>
        </div>
      </div>
    </>
