        ...
        <div className="notification__content">
          ...
          {Array.isArray(notification?.confirm?.statements) &&
            notification.confirm.statements.length > 0 && (
              <div
                className={`notification__confirm ${notification.confirm.statements.length > 2 ? "notification__confirm-col" : ""
                  }`}
              >
          ...
          {apiErrors && (
            <div className="notification__api-errors">
              <div className="error-message">
                {typeof apiErrors.message === "string" ? apiErrors.message : JSON.stringify(apiErrors.message)}
              </div>
