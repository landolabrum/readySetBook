...
export default class IconHelper {
  ...
  /**
   * Returns all available icon names. Optionally filter by a substring.
   */
  public static listIconNames(query?: string): string[] {
    const names = Object.keys(Icons ?? {});
    if (!query) return names.sort((a, b) => a.localeCompare(b));
