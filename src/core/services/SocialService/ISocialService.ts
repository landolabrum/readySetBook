...
export type IGAudience = "public" | "practice" | "close_friends";

export interface IGLiveCreateRequest {
  username?: string;
  stripe_id?: string;
  title: string;
  audience: IGAudience;
...
export interface IGLiveCreateResponse {
  status: "ok" | "error";
  username?: string;
  title?: string;
  audience?: IGAudience;
...
export interface IGKeepAliveResponse extends IGDeviceSession {
  status: "ok" | "warning" | "missing_session" | "error";
  username?: string;
  refreshed_at?: string;
  warning?: string;
  error?: string;
...
export default interface ISocialService {
  ...
  instagramLiveCreate(req: IGLiveCreateRequest): Promise<IGLiveCreateResponse>;
  instagramKeepAlive(username: string): Promise<IGKeepAliveResponse>;
