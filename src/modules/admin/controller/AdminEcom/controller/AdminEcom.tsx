...
import styles from './AdminEcom.scss';
...
import AdminData from '../../Fleet/views/AdminData/controller/AdminData';
import RemoteAccessPage from '../../Fleet/views/AdminRemote/controller/RemoteAccessPage';
...
const AdminTen: React.FC = () => {
  ...
  const baseViews = useMemo(() => ({
    dashboard: <>
      <UiButtonGroup btns={links} variant="tabs" />
    </>,
